...
namespace PlasticMetal.MobileSuit.IO
{
    partial class IoServer
    {
        ...
        private void ClearProgressBars()
        {
            ...
            for (var i = 0; i < ProgressBars.Count; i++) Output.WriteLine(Clear);
        ...
        private void PrintProgressBars()
        {
            ...
            if (Console.CursorLeft != 0)
                Console.SetCursorPosition(0, Console.CursorTop + 1);
            foreach (var progressBar in ProgressBars) Console.WriteLine(progressBar.Progress);
            Console.SetCursorPosition(LastCursorLocation.Item1, LastCursorLocation.Item2);
        }
        ...
        private async Task ClearProgressBarsAsync()
        {
            ...
            if (Console.CursorLeft != 0)
                Console.SetCursorPosition(0, Console.CursorTop + 1);
            for (var i = 0; i < ProgressBars.Count; i++) await Output.WriteLineAsync(Clear);
            Console.SetCursorPosition(LastCursorLocation.Item1, LastCursorLocation.Item2);
        }
        ...
        private async Task PrintProgressBarsAsync()
        {
            ...
            if (Console.CursorLeft != 0)
                Console.SetCursorPosition(0, Console.CursorTop + 1);
            foreach (var progressBar in ProgressBars) await Output.WriteLineAsync(progressBar.Progress);
            Console.SetCursorPosition(LastCursorLocation.Item1, LastCursorLocation.Item2);
        }
        ...
        {
            foreach (var progressBar in ProgressBars) progressBar.ProgressChanged -= ProgressBarUpdate;

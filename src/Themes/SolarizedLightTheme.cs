...
/// <summary>
/// Solarized light color theme for MobileSuit.
/// Official: https://ethanschoonover.com/solarized/
/// </summary>
public class SolarizedLightTheme : IColorSetting
{
    public SolarizedLightTheme()
    {
        // 根据 Solarized 官方调色板设置
        // 由于规格没有提供具体值，使用官方 Solarized Light 调色板
        DefaultColor = Color.FromArgb(101, 123, 131);     // Base00 (规格中的 InputColor)
        ...
        // MobileSuit 额外需要的颜色
        SystemColor = Color.FromArgb(238, 232, 213);      // Base2
        BackgroundColor = Color.FromArgb(253, 246, 227);  // Base3
    }
